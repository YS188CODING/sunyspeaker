(() => {
  ...
  if (why) {
    ...
    if (grid) {
      ...
      grid.innerHTML = '<article><span>01</span><h3>30+ YEARS OF FOCUS</h3><p>More than 30 years of loudspeaker driver engineering and manufacturing experience.</p></article><article><span>02</span><h3>INTEGRATED &amp; AGILE SUPPLY CHAIN</h3><p>Materials, components and production resources are coordinated for fast development, prototyping and production.</p></article><article><span>03</span><h3>CUSTOM ENGINEERING</h3><p>Acoustic, mechanical and material engineering is tailored to your application, dimensions and performance targets.</p></article><article><span>04</span><h3>QUALITY CONTROL</h3><p>Testing and process control help keep performance consistent from prototype through production.</p></article>';
    }
  }
